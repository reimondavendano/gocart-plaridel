...
export default function CategoriesPage() {
    // Get product count per category from actual products
    const getCategoryProductCount = (categorySlug: string) => {
        return mockProducts.filter(p => p.category === categorySlug).length;
    };
                                            ...
                                            <div className="flex items-center justify-between">
                                                <div className="flex items-center gap-2 text-mocha-600">
                                                    ...
                                                    <span className="text-sm">
                                                        <span className="font-semibold text-mocha-800">{productCount}</span> products
                                                    </span>
                                                </div>
