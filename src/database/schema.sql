...
('11111111-aaaa-bbbb-cccc-111111111111', 'Plaridel'),
('22222222-aaaa-bbbb-cccc-222222222222', 'Bustos'),
('33333333-aaaa-bbbb-cccc-333333333333', 'Pulilan');

-- 2. Insert Barangays (Complete list)
INSERT INTO barangays (id, city_id, name) VALUES
-- Bustos Barangays (14)
('b0000001-2222-3333-4444-b00000000001', '22222222-aaaa-bbbb-cccc-222222222222', 'Bonga Mayor'),
('b0000002-2222-3333-4444-b00000000002', '22222222-aaaa-bbbb-cccc-222222222222', 'Bonga Menor'),
('b0000003-2222-3333-4444-b00000000003', '22222222-aaaa-bbbb-cccc-222222222222', 'Buisan'),
('b0000004-2222-3333-4444-b00000000004', '22222222-aaaa-bbbb-cccc-222222222222', 'Camachilihan'),
('b0000005-2222-3333-4444-b00000000005', '22222222-aaaa-bbbb-cccc-222222222222', 'Cambaog'),
('b0000006-2222-3333-4444-b00000000006', '22222222-aaaa-bbbb-cccc-222222222222', 'Catacte'),
('b0000007-2222-3333-4444-b00000000007', '22222222-aaaa-bbbb-cccc-222222222222', 'Liciada'),
('b0000008-2222-3333-4444-b00000000008', '22222222-aaaa-bbbb-cccc-222222222222', 'Malamig'),
('b0000009-2222-3333-4444-b00000000009', '22222222-aaaa-bbbb-cccc-222222222222', 'Malawak'),
('b0000010-2222-3333-4444-b00000000010', '22222222-aaaa-bbbb-cccc-222222222222', 'Poblacion'),
('b0000011-2222-3333-4444-b00000000011', '22222222-aaaa-bbbb-cccc-222222222222', 'San Pedro'),
('b0000012-2222-3333-4444-b00000000012', '22222222-aaaa-bbbb-cccc-222222222222', 'Talampas'),
('b0000013-2222-3333-4444-b00000000013', '22222222-aaaa-bbbb-cccc-222222222222', 'Tanawan'),
('b0000014-2222-3333-4444-b00000000014', '22222222-aaaa-bbbb-cccc-222222222222', 'Tibagan'),

-- Plaridel Barangays (19)
('a0000001-1111-2222-3333-a00000000001', '11111111-aaaa-bbbb-cccc-111111111111', 'Agnaya'),
('a0000002-1111-2222-3333-a00000000002', '11111111-aaaa-bbbb-cccc-111111111111', 'Bagong Silang'),
('a0000003-1111-2222-3333-a00000000003', '11111111-aaaa-bbbb-cccc-111111111111', 'Banga I'),
('a0000004-1111-2222-3333-a00000000004', '11111111-aaaa-bbbb-cccc-111111111111', 'Banga II'),
('a0000005-1111-2222-3333-a00000000005', '11111111-aaaa-bbbb-cccc-111111111111', 'Bintog'),
('a0000006-1111-2222-3333-a00000000006', '11111111-aaaa-bbbb-cccc-111111111111', 'Bulihan'),
('a0000007-1111-2222-3333-a00000000007', '11111111-aaaa-bbbb-cccc-111111111111', 'Culianin'),
('a0000008-1111-2222-3333-a00000000008', '11111111-aaaa-bbbb-cccc-111111111111', 'Dampol'),
('a0000009-1111-2222-3333-a00000000009', '11111111-aaaa-bbbb-cccc-111111111111', 'Lagundi'),
('a0000010-1111-2222-3333-a00000000010', '11111111-aaaa-bbbb-cccc-111111111111', 'Lalangan'),
('a0000011-1111-2222-3333-a00000000011', '11111111-aaaa-bbbb-cccc-111111111111', 'Lumang Bayan'),
('a0000012-1111-2222-3333-a00000000012', '11111111-aaaa-bbbb-cccc-111111111111', 'Parulan'),
('a0000013-1111-2222-3333-a00000000013', '11111111-aaaa-bbbb-cccc-111111111111', 'Poblacion'),
('a0000014-1111-2222-3333-a00000000014', '11111111-aaaa-bbbb-cccc-111111111111', 'Rueda'),
('a0000015-1111-2222-3333-a00000000015', '11111111-aaaa-bbbb-cccc-111111111111', 'San Jose'),
('a0000016-1111-2222-3333-a00000000016', '11111111-aaaa-bbbb-cccc-111111111111', 'Santa Ines'),
('a0000017-1111-2222-3333-a00000000017', '11111111-aaaa-bbbb-cccc-111111111111', 'Santo Niño'),
('a0000018-1111-2222-3333-a00000000018', '11111111-aaaa-bbbb-cccc-111111111111', 'Sipat'),
('a0000019-1111-2222-3333-a00000000019', '11111111-aaaa-bbbb-cccc-111111111111', 'Tabang'),

-- Pulilan Barangays (19)
('c0000001-3333-4444-5555-c00000000001', '33333333-aaaa-bbbb-cccc-333333333333', 'Balatong A'),
('c0000002-3333-4444-5555-c00000000002', '33333333-aaaa-bbbb-cccc-333333333333', 'Balatong B'),
('c0000003-3333-4444-5555-c00000000003', '33333333-aaaa-bbbb-cccc-333333333333', 'Cutcot'),
('c0000004-3333-4444-5555-c00000000004', '33333333-aaaa-bbbb-cccc-333333333333', 'Dampol I'),
('c0000005-3333-4444-5555-c00000000005', '33333333-aaaa-bbbb-cccc-333333333333', 'Dampol II-A'),
('c0000006-3333-4444-5555-c00000000006', '33333333-aaaa-bbbb-cccc-333333333333', 'Dampol II-B'),
('c0000007-3333-4444-5555-c00000000007', '33333333-aaaa-bbbb-cccc-333333333333', 'Dulong Malabon'),
('c0000008-3333-4444-5555-c00000000008', '33333333-aaaa-bbbb-cccc-333333333333', 'Inaon'),
('c0000009-3333-4444-5555-c00000000009', '33333333-aaaa-bbbb-cccc-333333333333', 'Longos'),
('c0000010-3333-4444-5555-c00000000010', '33333333-aaaa-bbbb-cccc-333333333333', 'Lumbac'),
('c0000011-3333-4444-5555-c00000000011', '33333333-aaaa-bbbb-cccc-333333333333', 'Paltao'),
('c0000012-3333-4444-5555-c00000000012', '33333333-aaaa-bbbb-cccc-333333333333', 'Penabatan'),
('c0000013-3333-4444-5555-c00000000013', '33333333-aaaa-bbbb-cccc-333333333333', 'Poblacion'),
('c0000014-3333-4444-5555-c00000000014', '33333333-aaaa-bbbb-cccc-333333333333', 'Santa Peregrina'),
('c0000015-3333-4444-5555-c00000000015', '33333333-aaaa-bbbb-cccc-333333333333', 'Santo Cristo'),
('c0000016-3333-4444-5555-c00000000016', '33333333-aaaa-bbbb-cccc-333333333333', 'Taal'),
('c0000017-3333-4444-5555-c00000000017', '33333333-aaaa-bbbb-cccc-333333333333', 'Tabon'),
('c0000018-3333-4444-5555-c00000000018', '33333333-aaaa-bbbb-cccc-333333333333', 'Tibag'),
('c0000019-3333-4444-5555-c00000000019', '33333333-aaaa-bbbb-cccc-333333333333', 'Tinejero');
...
-- 7. Insert Stores
INSERT INTO stores (id, seller_id, name, slug, description, logo, banner, address_id, status, valid_id_front, valid_id_back, business_permit, selfie_image, latitude, longitude, verification_notes, verified_at, verified_by, rating, total_reviews, total_products, total_sales, inquiry_link, created_at, updated_at) VALUES
